...
namespace CarRentalWebApi.Controllers
{
    ...
    public class VidangeController : ControllerBase
    {
        ...
        public JsonResult Put(Vidange vidange)
        {
            try
            {
                ado.crud<bool>(@"update Vidange set Immatricule='" + vidange.Immatricule + "',Date='" + vidange.Date + "',Km_Actuel=" + vidange.Km_Actuel + ",Type_de_vidange=" + vidange.Type_de_vidange + ",Km_Prochain_vidange=" + vidange.Km_Prochain_vidange + ",Alerte_si_reste=" +vidange.Alerte_si_reste + ",Cout=" + vidange.Cout + " where idVidange=" + vidange.idVidange + " ", "ExecuteNonQuery");
        ...
        {
            ado.crud<bool>("delete from Vidange where idVidange=" + id + "", "ExecuteNonQuery");
